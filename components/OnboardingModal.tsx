          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-black/30 border border-skyrim-border rounded">
              <p className="text-gray-300 text-sm font-sans">
                Tip: You can skip anytime. The tutorial won’t show again after you finish or skip.
              </p>
            </div>
          </div>
        ),
      ...
      },
      {
        ...
        body: (
          <div className="space-y-3">
            ...
            <ul className="text-gray-300 text-sm font-sans list-disc pl-5 space-y-1">
              <li>Type what you do or say (“I knock and ask about the missing caravan…”).</li>
