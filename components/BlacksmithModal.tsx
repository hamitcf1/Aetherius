                ...
                <button key={it.id} onClick={() => setSelectedId(it.id)} className={`w-full text-left p-3 rounded border ${selectedId === it.id ? 'border-skyrim-gold bg-skyrim-gold/10' : 'border-skyrim-border hover:border-skyrim-gold/40'}`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="p-2 rounded bg-black/40 text-skyrim-gold">{it.type === 'weapon' ? <Sword size={16}/> : <Shield size={16}/>}</div>
                      <div>
                        <div className="text-skyrim-gold font-serif">{it.name}</div>
                        <div className="text-xs text-gray-400">Lvl {it.upgradeLevel || 0} / {getMaxUpgradeForItem(it)}</div>
                      </div>
                    </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-gray-400">Type: {selected.type}</div>
                      </div>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="text-xs mt-1 text-gray-400">Max Level: {getMaxUpgradeForItem(selected)}</div>
                      {(() => {
