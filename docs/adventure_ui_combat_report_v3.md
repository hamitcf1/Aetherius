...
- Expand loot tables & auto-award implemented ✔ — Added `data/lootTables.ts`, updated `services/lootService.ts` to sample by enemy type with rarity, level and boss scaling, and guaranteed fallback rewards.
