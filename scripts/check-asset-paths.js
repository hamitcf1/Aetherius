...
const IGNORED_DIRS = ['node_modules', '.git', 'dist', 'public', 'assets'];
const FILE_EXTENSIONS = ['.ts', '.tsx', '.js', '.jsx', '.html', '.css', '.md'];

const forbiddenPatterns = [
  { name: 'Hard-coded /skyaetherius', regex: /\/skyaetherius\//g },
  // Relative asset references that look like runtime assets (not JS/TS imports)
